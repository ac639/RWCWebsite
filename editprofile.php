      ...
      <div class="row h-100">
        <div class="col-lg-7 my-auto">
          <div class="header-content mx-auto">
            ...
            <form method = "post" action="editprofile_auth.php">
                <input class="form-control" type="text" placeholder="Description about myself" name="profile">
				<br>
			    <input class="btn btn-outline btn-xl js-scroll-trigger" type="submit" name="editprofile" value="Submit">
